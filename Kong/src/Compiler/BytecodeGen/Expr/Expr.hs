...
import Compiler.Type.Checks (isKonst, comparisonOps, arithOps, logicalOps, checkComparisonTypes, signOps, singleOps)
...
compileFunctionCall fexp args env lnCount =
  case maybeFuncName fexp of
    Just name | name `elem` (singleOps), length args == 1 -> case args of
