...
testParseCharSuccess =
  TestCase (assertEqual "should parse 'c'"
    (Right ('c', ("aca", (0,1))))
    (runParser (parseChar 'c') ("caca", (0,0))))

testParseCharFail :: Test
testParseCharFail =
  TestCase (assertBool "should fail on wrong char"
...
testParseStringSuccess =
  TestCase (assertEqual "should parse string 'hello'"
    (Right ("hello", (" world", (0,5))))
    (runParser (parseString "hello") ("hello world", (0,0))))

testParseStringFail :: Test
testParseStringFail =
  TestCase (assertBool "should fail parsing wrong string"
...
testParseInt :: Test
testParseInt =
  TestCase (assertEqual "should parse int"
    (Right (123, ("abc", (0,3))))
    (runParser parseInt ("123abc", (0,0))))

testParseFloat :: Test
testParseFloat =
  TestCase (assertEqual "should parse float"
    (Right (12.34, ("xyz", (0,5))))
